...
type GetTransactionParams struct {
	Filter     ParamTrxFilter     `form:"filter,omitempty" json:"filter,omitempty"`
	RangeStart ParamTrxRangeStart `form:"range_start,omitempty" json:"range_start,omitempty"`
	RangeEnd   ParamTrxRangeEnd   `form:"range_end,omitempty" json:"range_end,omitempty"`
}
